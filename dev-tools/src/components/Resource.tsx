...
export default function Resource({ data }: Props) {
    return (
        <div className="relative border border-gray-200h-auto px-8 py-5 pb-5 max-w-[25rem] w-auto rounded-md">
            <span className="flex items-center gap-4">
                <img src={data.logoSrc} alt={`${data.name} logo`} className="w-10 h-10 object-contain" />
